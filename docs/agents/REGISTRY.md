...
| DepartmentManagement | Vertical | Custom | src/app-modules/department-management/ | docs/agents/department-management-agent.SKILL.md |
| DeptInfoManagement | Vertical | Custom | src/app-modules/dept-info-management/ | docs/agents/dept-info-management-agent.SKILL.md |
| DeptPeopleManagement | Vertical | Custom | src/app-modules/dept-people-management/ | docs/agents/dept-people-management-agent.SKILL.md |
| DeptResearchManagement | Vertical | Custom | src/app-modules/dept-research-management/ | docs/agents/dept-research-management-agent.SKILL.md |
| DeptAcademicsManagement | Vertical | Custom | src/app-modules/dept-academics-management/ | docs/agents/dept-academics-management-agent.SKILL.md |
| DeptActivitiesManagement | Vertical | Custom | src/app-modules/dept-activities-management/ | docs/agents/dept-activities-management-agent.SKILL.md |
