# AlumniManagement Agent

> Type: Vertical Module Agent | Module: src/core-modules/alumni-management/ or src/app-modules/alumni-management/
...
2. Read the module's MODULE.md for module spec (path is src/core-modules/alumni-management/ or src/app-modules/alumni-management/ per REGISTRY).
...
7. Publish AlumniManagement* events via EventBridge for state changes.
