# DepartmentManagement Agent

> Type: Vertical Module Agent | Module: src/core-modules/department-management/ or src/app-modules/department-management/
...
2. Read the module's MODULE.md for module spec (path is src/core-modules/department-management/ or src/app-modules/department-management/ per REGISTRY).
...
7. Publish DepartmentManagement* events via EventBridge for state changes.
