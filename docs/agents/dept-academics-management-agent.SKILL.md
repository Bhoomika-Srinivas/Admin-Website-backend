# DeptAcademicsManagement Agent

> Type: Vertical Module Agent | Module: src/core-modules/dept-academics-management/ or src/app-modules/dept-academics-management/
...
2. Read the module's MODULE.md for module spec (path is src/core-modules/dept-academics-management/ or src/app-modules/dept-academics-management/ per REGISTRY).
...
7. Publish DeptAcademicsManagement* events via EventBridge for state changes.
