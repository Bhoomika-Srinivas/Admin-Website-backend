# DeptActivitiesManagement Agent

> Type: Vertical Module Agent | Module: src/core-modules/dept-activities-management/ or src/app-modules/dept-activities-management/
...
2. Read the module's MODULE.md for module spec (path is src/core-modules/dept-activities-management/ or src/app-modules/dept-activities-management/ per REGISTRY).
...
7. Publish DeptActivitiesManagement* events via EventBridge for state changes.
