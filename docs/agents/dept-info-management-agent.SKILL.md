# DeptInfoManagement Agent

> Type: Vertical Module Agent | Module: src/core-modules/dept-info-management/ or src/app-modules/dept-info-management/
...
2. Read the module's MODULE.md for module spec (path is src/core-modules/dept-info-management/ or src/app-modules/dept-info-management/ per REGISTRY).
...
7. Publish DeptInfoManagement* events via EventBridge for state changes.
