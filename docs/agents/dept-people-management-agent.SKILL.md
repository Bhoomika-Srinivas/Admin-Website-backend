# DeptPeopleManagement Agent

> Type: Vertical Module Agent | Module: src/core-modules/dept-people-management/ or src/app-modules/dept-people-management/
...
2. Read the module's MODULE.md for module spec (path is src/core-modules/dept-people-management/ or src/app-modules/dept-people-management/ per REGISTRY).
...
7. Publish DeptPeopleManagement* events via EventBridge for state changes.
