# DeptResearchManagement Agent

> Type: Vertical Module Agent | Module: src/core-modules/dept-research-management/ or src/app-modules/dept-research-management/
...
2. Read the module's MODULE.md for module spec (path is src/core-modules/dept-research-management/ or src/app-modules/dept-research-management/ per REGISTRY).
...
7. Publish DeptResearchManagement* events via EventBridge for state changes.
