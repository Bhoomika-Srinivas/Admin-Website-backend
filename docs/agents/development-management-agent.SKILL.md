# DevelopmentManagement Agent

> Type: Vertical Module Agent | Module: src/core-modules/development-management/ or src/app-modules/development-management/
...
2. Read the module's MODULE.md for module spec (path is src/core-modules/development-management/ or src/app-modules/development-management/ per REGISTRY).
...
7. Publish DevelopmentManagement* events via EventBridge for state changes.
