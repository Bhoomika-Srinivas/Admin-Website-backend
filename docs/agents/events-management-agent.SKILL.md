# EventsManagement Agent

> Type: Vertical Module Agent | Module: src/core-modules/events-management/ or src/app-modules/events-management/
...
2. Read the module's MODULE.md for module spec (path is src/core-modules/events-management/ or src/app-modules/events-management/ per REGISTRY).
...
7. Publish EventsManagement* events via EventBridge for state changes.
