# FacultyManagement Agent

> Type: Vertical Module Agent | Module: src/core-modules/faculty-management/ or src/app-modules/faculty-management/
...
2. Read the module's MODULE.md for module spec (path is src/core-modules/faculty-management/ or src/app-modules/faculty-management/ per REGISTRY).
...
7. Publish FacultyManagement* events via EventBridge for state changes.
