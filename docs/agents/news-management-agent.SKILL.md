# NewsManagement Agent

> Type: Vertical Module Agent | Module: src/core-modules/news-management/ or src/app-modules/news-management/
...
2. Read the module's MODULE.md for module spec (path is src/core-modules/news-management/ or src/app-modules/news-management/ per REGISTRY).
...
7. Publish NewsManagement* events via EventBridge for state changes.
