# TeamManagement Agent

> Type: Vertical Module Agent | Module: src/core-modules/team-management/ or src/app-modules/team-management/
...
2. Read the module's MODULE.md for module spec (path is src/core-modules/team-management/ or src/app-modules/team-management/ per REGISTRY).
...
7. Publish TeamManagement* events via EventBridge for state changes.
