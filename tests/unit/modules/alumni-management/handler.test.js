...
/**
 * Handler test skeleton for module alumni-management.
...
const { handler } = require('../../../../src/app-modules/alumni-management/functions/handler');
...
describe('alumni-management handler', () => {
