...
/**
 * Handler test skeleton for module department-management.
...
const { handler } = require('../../../../src/core-modules/department-management/functions/handler');
...
describe('department-management handler', () => {
