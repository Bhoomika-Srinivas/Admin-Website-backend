...
/**
 * Handler test skeleton for module dept-branding-management.
...
const { handler } = require('../../../../src/core-modules/dept-branding-management/functions/handler');
...
describe('dept-branding-management handler', () => {
