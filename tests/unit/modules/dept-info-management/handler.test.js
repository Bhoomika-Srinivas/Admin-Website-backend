...
/**
 * Handler test skeleton for module dept-info-management.
...
const { handler } = require('../../../../src/core-modules/dept-info-management/functions/handler');
...
describe('dept-info-management handler', () => {
