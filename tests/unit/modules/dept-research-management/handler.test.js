...
/**
 * Handler test skeleton for module dept-research-management.
...
const { handler } = require('../../../../src/core-modules/dept-research-management/functions/handler');
...
describe('dept-research-management handler', () => {
