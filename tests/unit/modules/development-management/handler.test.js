...
/**
 * Handler test skeleton for module development-management.
...
const { handler } = require('../../../../src/core-modules/development-management/functions/handler');
...
describe('development-management handler', () => {
