...
/**
 * Handler test skeleton for module events-management.
...
const { handler } = require('../../../../src/app-modules/events-management/functions/handler');
...
describe('events-management handler', () => {
