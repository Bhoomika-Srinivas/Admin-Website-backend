...
/**
 * Handler test skeleton for module faculty-management.
...
const { handler } = require('../../../../src/core-modules/faculty-management/functions/handler');
...
describe('faculty-management handler', () => {
