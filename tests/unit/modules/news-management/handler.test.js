...
/**
 * Handler test skeleton for module news-management.
...
const { handler } = require('../../../../src/core-modules/news-management/functions/handler');
...
describe('news-management handler', () => {
