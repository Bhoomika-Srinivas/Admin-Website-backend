...
/**
 * Handler test skeleton for module team-management.
...
const { handler } = require('../../../../src/core-modules/team-management/functions/handler');
...
describe('team-management handler', () => {
